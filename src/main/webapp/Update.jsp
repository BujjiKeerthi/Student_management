                ...
                <tr>
                    ...
                    <td>
                        <form action="update1" method="post">
                            ...
                            <input type="text" name="name" value="<%=stud.getCourseName()%>" hidden>
                            <input type="text" name="info" value="<%=stud.getCourseInfo()%>" hidden>
                            <input type="number" name="month" value="<%=stud.getMonth()%>" hidden>
                            <input type="number" name="fee" value="<%=stud.getFees()%>" hidden>
