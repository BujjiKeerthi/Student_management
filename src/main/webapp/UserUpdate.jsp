                     ...
                     <table border="1">
                          <tr>
                              ...
                              <tr>
                                  ...
                                  <input type="number" name='id' value="<%=st.getId() %>" hidden >
                                  <input type="text" name='name' value="<%=st.getName() %>" hidden >
                                  <input type="mail" name='mail' value="<%=st.getGmail() %>" hidden >
                                  <input type="number" name='phone' value="<%=st.getPhone() %>" hidden >
